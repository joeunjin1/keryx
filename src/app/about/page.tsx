...
const texts = {
  ko: {
    ...
    pillars: [
      { title: "오리지널 IP 개발", desc: "뿌지프랜즈(8종), 디노몬(6종), 덕클(1종) — 15종의 오리지널 캐릭터를 직접 개발하고 세계관을 구축합니다.", icon: "🎨" },
    ...
    stats: [
      ...
      { value: "71개", label: "완성 디자인" },
      { value: "3개", label: "IP 세계관" },
      { value: "연재중", label: "스토리·동화" },
    ],
  ...
  zh: {
    ...
    pillars: [
      { title: "原创IP开发", desc: "噗吉朋友(8种)、恐龙怪兽(6种)、鸭克(1种) — 直接开发15种原创角色并构建世界观。", icon: "🎨" },
    ...
    stats: [
      ...
      { value: "71个", label: "完成设计" },
      { value: "3个", label: "IP世界观" },
      { value: "连载中", label: "故事·童话" },
    ],
    cta_title: "正在招募合作伙伴",
