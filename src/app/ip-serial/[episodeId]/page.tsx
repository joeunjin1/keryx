...
const EPISODE_CONTENTS: Record<string, EpisodeContent> = {
  'ppuji-ft-01': {
    ...
    content_ko: [
      ...
      '바삭하고 달콤한 쿠키를 먹으며 당뿌는 생각했습니다. 뿌지빌리지에서 가장 좋은 것은 바로 이런 따뜻한 아침이라고.',
  ...
  'ppuji-ft-02': {
    ...
    content_ko: [
      ...
      '축제 날, 모찌의 무지개 떡은 뿌지빌리지 역사상 가장 아름답고 맛있는 요리가 되었습니다.',
      '— 계속 —',
    ],
    content_zh: [
      '噗吉村庄的节日近在眼前。',
