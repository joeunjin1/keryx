...
export default function MdPlatformSettingsPage() {
    ...
    <div style={{ maxWidth: 720, margin: '0 auto', padding: '24px 16px' }}>
      <div style={{ marginBottom: 28 }}>
        ...
        <div style={{ fontSize: 13, color: 'var(--text-tertiary)' }}>
          {t('담당 바이어에게 적용되는 매칭공장 할인율을 조정합니다.', '调整适用于负责买家的匹配工厂折扣率。')}
        </div>
      </div>
              ...
              <div key={key} style={{
                ...
                <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
                  ...
                  <button
                    ...
                    style={{
                      padding: '8px 20px', borderRadius: 10, fontSize: 13, fontWeight: 700,
                      background: isSaved ? '#10b981' : 'linear-gradient(135deg, #10b981, #059669)',
      ...
      <div style={{
        marginTop: 28, background: 'linear-gradient(135deg, #f0fdf4, #dcfce7)',
        border: '1px solid #bbf7d0', borderRadius: 16, padding: '16px 20px',
      }}>
        ...
        <div style={{ fontSize: 12, color: '#6b7280', lineHeight: 1.8 }}>
          {t(
            'MD는 플랫폼 전체 할인율을 조정할 수 있습니다. 변경사항은 즉시 모든 바이어의 대시보드에 반영됩니다.',
            'MD可以调整平台整体折扣率。更改将立即反映在所有买家的仪表板上。'
          )}
        </div>
      </div>
    </div>
