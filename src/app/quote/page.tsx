...
const T = {
  ko: {
    ...
    desired_deadline_ph: '예: 2026년 10월, 약 60일 이내 등',
    ...
    deadline_ph: '예: 2026년 9월, 약 60일 이내 등',
  ...
  zh: {
    ...
    desired_deadline_ph: '例：2026年10月、约60天内等',
  ...
  en: {
    ...
    desired_deadline_ph: 'e.g. October 2026, within 60 days, etc.',
    ...
    deadline_ph: 'e.g. September 2026, within 60 days, etc.',
