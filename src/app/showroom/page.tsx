...
const IP_CHARACTERS = [
  {
    ...
    characters: [
      { name_ko: '뿌찌', name_zh: '噗奇', color: '#FF6B9D' },
      { name_ko: '뿌찌베어', name_zh: '噗奇熊', color: '#FF8FAB' },
      { name_ko: '뿌찌버니', name_zh: '噗奇兔', color: '#FFB3CC' },
    ],
  },
  {
    slug: 'duckle',
  ...
  },
  {
    ...
    characters: [
      { name_ko: '디노', name_zh: '迪诺', color: '#6BCB77' },
      { name_ko: '렉스', name_zh: '雷克斯', color: '#A8E6CF' },
      { name_ko: '트리케', name_zh: '三角龙', color: '#4CAF50' },
    ],
  },
];
