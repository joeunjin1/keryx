...
const navLabels = {
  ko: {
    ...
    dashboard: '대시보드',
    admin: '관리자',
    ipBizDesc: '캐릭터 소개 · 스토리 연재 · 쇼룸',
    productBizDesc: 'IP 굿즈 · 제조 서비스 · 견적',
  ...
  zh: {
    ...
    dashboard: '控制台',
    admin: '管理员',
    ipBizDesc: '角色介绍 · 故事连载 · 展厅',
    productBizDesc: 'IP周边 · 制造服务 · 报价',
  ...
  en: {
    ...
    ipStory: 'IP Story',
    ipSerial: 'IP Serial',
    showroom: 'IP Characters',
    catalog: 'IP Product Catalog',
    ...
    dashboard: 'Dashboard',
    admin: 'Admin',
    ipBizDesc: 'Characters · Story · Showroom',
    productBizDesc: 'IP Goods · Manufacturing · Quote',
